...
void Faculty::setId(int idx)
{
    id = idx;
}
void Faculty::setName(string str)
{
    name = str;
}
void Faculty::setPhoneNumber(string str)
{
    phonenumber=str;
}
void Faculty::setAddress(string str)
{
    address=str;
}
int Faculty::getId()
...
void Faculty::addBook(Books b1)
{
    ...
    else if (b1.getId() != -1 && size < max_books_faculty && regester == true)
    {
