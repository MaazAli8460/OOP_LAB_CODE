...
void Students::setId(int idx)
{
    id = idx;
}
void Students::setName(string str)
{
    name = str;
}
void Students::setPhoneNumber(string str)
{
    phonenumber=str;
}
void Students::setAddress(string str)
{
    address=str;
}
int Students::getId()
...
string Students::getPhoneNumber()
{
    return phonenumber;
}
